              ...
              <div className="flex flex-row justify-between">
                <div>
                  <label htmlFor="remember" className="">
                    <input type="checkbox" id="remember" className="w-4 h-4 border-slate-200 focus:bg-gray-600" />
                    Remember me
                  </label>
                </div>
                <div>
                  <a href="#" className="font-medium text-gray-800 hover:text-orange-600">Forgot Password?</a>
                </div>
              </div>
